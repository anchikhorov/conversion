...
win32gui.ShowWindow(IllustratorWindow,win32con.SW_SHOW)
win32gui.ShowWindow(InDesignWindow,win32con.SW_SHOW)
CorelPhotoPaintWindow.Visible = True
CorelDrawWindow.Visible = True